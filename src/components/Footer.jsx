  ...
  return (
    <footer className=" flex flex-nowrap w-[100%] xl:h-[270px] mt-[50px] bg-[rgba(164,246,222,1)] py-4 sm:py-8 text-gray-800 text-center">
      <div className="container mx-auto px-6">
        {/* Footer Top */}
        <div className=" xl:h-[150px] flex flex-row-reverse sm:gap-7 md:gap-10 lg:gap-50 xl:gap-80 text-right">
        ...
        {/* Footer Bottom  */}
        <div className="w-[100%] xl:h-[100px] border-t  border-gray-400 my-6 ">
          <div className="flex flex-row-nowrap justify-center space-x-4 mb-4"></div>
          <p className="my-[-10px] text-xs sm:text-sm md:text-base  text-gray-600 text-end">
