...
function ReusablePanelNavigation({ children, navIcon, to, extraStyle }) {
  return (
    <NavLink
      ...
      className={({ isActive }) =>
        isActive
          ? `w-[75%] h-[50px] mx-[auto] block rounded-[45px] mt-[13px] flex flex-row flex-nowrap justify-between bg-[rgba(21,139,104,1)] text-[rgba(255,255,255,1)] ${extraStyle}`
          : `w-[75%] h-[50px] mx-[auto] block rounded-[45px] mt-[13px] flex flex-row flex-nowrap justify-between ${extraStyle} text-[rgba(21,139,104,1)]`
      }
    >
