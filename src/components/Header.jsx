...
function Header() {
  ...
  if (location.pathname === "/")
    ...
    return (
      <div className="header-container w-[100%] h-[80px] flex flex-nowrap flex-row items-center justify-between bg-linear-to-br from-[rgba(164,246,222,1)] to-[rgba(255,255,255,1)]">
        <HeaderSignInBtn />
        <HeaderNavigations />
        <Logo />
      </div>
