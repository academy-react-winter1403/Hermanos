    ...
    <div className="course-card w-[250px] sm:w-[290px] h-[570px]  relative cursor-pointer ">
      ...
      <div className="course-card-body h-[440px] sm:h-[445px] w-[100%] absolute top-[75px] bg-[rgba(251,246,246,1)] rounded-[34px] shadow-[7px_7px_7px_0px_rgba(0,0,0,0.16)] hover:shadow-[9px_9px_5px_0px_rgba(0,0,0,0.16)]">
        <div className="course-status mx-[auto] mt-[90px] h-[40px] w-[87%] flex flex-row flex-nowrap justify-between items-center">
          <Like likeCount={likeCount} dissLikeCount={dissLikeCount} />
        ...
        <div className="score&teacher mx-[auto] mt-[15px] h-[30px] w-[87%] flex flex-row flex-nowrap justify-between">
          <div className="star-score w-[45px] h-[100%] flex flex-row flex-nowrap">
            ...
            <div className="score w-[30%] h-[100%] text-[12px] text-[rgba(8,158,113,1)] leading-[25px]">
              4.8
            </div>
          </div>
          <CourseReusableTeacher teacherName={teacherName} />
        </div>
        <p className="speach-time mt-[15px] block mx-[auto] text-[9px] w-[87%] text-end text-[rgba(65,167,137,1)]">
          سخنرانی (120ساعت)50
        </p>
        <p className="course-description overflow-hidden h-[64px] mt-[10px] mb-4 sm:mb-0 block mx-[auto] text-[12px] w-[87%] text-end text-[rgba(109,103,103,1)]">
          {desc}
        </p>
        <div className="course-price mt-[10px] border-t pt-[7px] border-t-[rgba(18,146,108,1)]  h-[35px] w-[87%] mx-[auto] flex flex-row flex-nowrap justify-center items-center">
          <div className="price w-[50%] h-[80%] text-nowrap text-[rgba(225,24,24,1)] text-sm sm:text-base xl:text-base">
            تومان {price}
          </div>
