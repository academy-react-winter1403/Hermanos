...
function SugesstCriticism() {
  return (
    <div className="sugesstion-criticism  w-[85%] h-[600px] mx-[auto] my-[50px] flex flex-row flex-nowrap justify-center">
      ...
      <div className="sugesstion-criticism-form  w-[55%] h-[100%] flex flex-col  items-end">
        <Formik>
          <Form>
            <Field
              placeholder="نام و نام خانوادگی"
              className="w-[100%] h-[80px] rounded-[14px]  border-[2px] border-[rgba(21,139,104,1)] text-end mt-[20px] "
            />
            <Field
              placeholder="ایمیل"
              className="w-[100%] h-[80px] rounded-[14px]  border-[2px] border-[rgba(21,139,104,1)] text-end mt-[20px] "
            ...
            <Field
              placeholder="متن"
              className="w-[100%] h-[210px] rounded-[14px]  border-[2px] border-[rgba(21,139,104,1)] text-end mt-[20px]"
            />
