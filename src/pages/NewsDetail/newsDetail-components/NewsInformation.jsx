...
function NewsInformation() {
  return (
    <div className="news-info w-[95%] h-[50px] mt-[20px] mb-[15px] flex flex-row flex-nowrap justify-between items-center">
      <div className="like-dis h-[80%] sm:h-[80%] lg:h-[100%] sm:mt-3">
        <Like />
      </div>
      <div className="news-information hidden sm:w-[370px] xl:w-[500px] h-[80%] sm:flex flex-row flex-nowrap justify-between">
        <div className=" w-[110px] h-[100%] flex flex-row flex-nowrap justify-center items-center">
          <div className=" w-[70%] h-[100%] text-center text-xs lg:text-[11px] leading-[35px]">
            کلمات کلیدی
          </div>
