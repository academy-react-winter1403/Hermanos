...
import CourseDetailDesc from "../CourseDetail/courseDetail-components/CourseDetailDesc";
import CourseDetailSugesstion from "../CourseDetail/courseDetail-components/CourseDetailSugesstion";
import CourseDetailVideo from "../CourseDetail/courseDetail-components/CourseDetailVideo";
import FirstCourseInfo from "../CourseDetail/courseDetail-components/FirstCourseInfo";
  ...
  return (
    <>
      <div className="course-details w-[100%] flex flex-row flex-nowrap gap-[20px] mt-[100px] justify-center mb-[80px]">
        <div className="detail-left  w-[450px] rounded-[30px] bg-[rgba(251,246,246,1)] p-[30px]">
          <div className="">
            <div className="course-info1 p-[20px] w-[100%] bg-[rgba(255,255,255,1)] rounded-[26px] mb-[25px]">
              ...
              />
              <FirstCourseInfo
                asking="تکنولوژی دوره"
                answering="نام تکنولوژی"
              />
            ...
            <div className="course-info3 p-[20px] w-[100%] bg-[rgba(255,255,255,1)] rounded-[26px] mb-[25px]">
              <FirstCourseInfo
                asking="تاریخ بروزرسانی"
                answering="1402/07/06"
              />
        ...
        <div className="detail-right w-[1100px] rounded-[30px] bg-[rgba(251,246,246,1)] p-[30px] pb-[120px] ">
      ...
      <Button style="mx-[auto] mb-[120px] border border-[2px] border-[rgba(18,146,108,1)] w-[230px] h-[60px] rounded-[51px] text-[rgba(255,255,255,1)] text-center text-[16px] leading-[50px] bg-[rgba(18,146,108,1)] mt-[50px]">
