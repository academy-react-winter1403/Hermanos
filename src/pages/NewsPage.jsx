...
function NewsPage() {
  return (
    <div className="mx-7">
      ...
      />
      <MainCoursesSearch />
      <div className="newsContainer border border-[rgba(239,239,239,1)] shadow-[10px_10px_7px_0px_rgba(0,0,0,0.16)] flex flex-wrap justify-center rounded-2xl mt-5 mb-5 ">
